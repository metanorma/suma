...
Commands:
  ...
  suma generate_schemas METANORMA_YAML_FILE # Generate Schemas YAML file from Metanorma YAML file
...
[source,sh]
----
$ suma generate_schemas METANORMA_YAML_FILE [options]
----
...
`--output=OUTPUT_FILE`, `-o OUTPUT_FILE`:: Path to write the generated
Schemas YAML file
If this option is specified but the OUTPUT_FILE is not, it will use the default
name (`schemas-smrl-all.yml`).
If this option is not specified, it will run in dry-run mode and print the
output to STDOUT.

`--exclude_lf`, `-e`:: Exclude schemas with names like `*_lf.exp`
...
[source,sh]
----
$ bundle exec suma generate_schemas metanorma-smrl-all.yml -o
# => generates schemas-smrl-all.yml
----

.To inspect the generated schemas YAML file
[source,sh]
----
$ bundle exec suma generate_schemas metanorma-smrl-all.yml
...
[source,sh]
----
$ bundle exec suma generate_schemas metanorma-smrl-all.yml -o -e
# => generates schemas-smrl-all.yml without schemas with names like *_lf.exp
----

.To inspect the generated schemas YAML file with excluded schemas
[source,sh]
----
$ bundle exec suma generate_schemas metanorma-smrl-all.yml -e
# => prints the output to STDOUT
----
