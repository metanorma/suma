...
independent EXPRESS files to a specified output directory.
...
An independent EXPRESS file (`.exp`)::: the schema will be exported directly
...
----
express-files/
├── geometry_schema.exp          # independent EXPRESS file (at root)
├── topology_schema.exp          # independent EXPRESS file (at root)
