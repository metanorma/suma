...
RSpec.describe Suma::SchemaComparer do
  ...
  describe "#compare" do
    context "when eengine is not available" do
      ...
      it "raises EengineNotAvailableError" do
        comparer = described_class.new(schema_v2, schema_v1)
        expect { comparer.compare }
          .to raise_error(Suma::EengineNotAvailableError)
      end
    end
    ...
    context "when trial schema does not exist" do
      ...
      it "raises SchemaNotFoundError" do
        ...
        expect { comparer.compare }
          .to raise_error(Suma::SchemaNotFoundError)
      end
    end
    ...
    context "when eengine is available and schemas exist" do
      ...
      it "handles no changes detected" do
        ...
        comparer = described_class.new(trial_schema, reference_schema,
                                       version: 1)
        expect { comparer.compare }.not_to raise_error
    ...
    describe "repository root detection" do
      it "detects git repository root" do
        ...
        root = comparer.send(:detect_repo_root, schema)
